...
def test_batch_mode():
                ...
                "messages": [
                    {"role": "system", "content": prompts},
                    {
                        ...
                        "content": [{
                            "type": "text",
                            "text": f"```json\n{input}\n```"
                        }, {'type': 'image_url', 'image_url': {'url': json.loads(input)['Image_URL']}}]
                    }
                ],
            }
        }
    ...
    with open('result/zero-shot-demo/eeg-demo/batch_request.json', 'w', encoding='utf-8') as f:
    ...
    with open('result/zero-shot-demo/eeg-demo/eeg_demo.json', 'w', encoding='utf-8') as f:
