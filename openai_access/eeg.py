...
def test_batch_mode():
    ...
    # 读取 all_prompts.md
    prompts_file_path = r'prompts/zero-shot-no-demo/实体类型验证与接地/eeg_英文.md'
    prompts = load_prompts(prompts_file_path)
    ...
    with open('result/zero-shot-no-demo/samples1500/eeg(MNER)/batch_request.json', 'w', encoding='utf-8') as f:
    ...
    with open('result/zero-shot-no-demo/samples1500/eeg(MNER)/eeg_results.json', 'w', encoding='utf-8') as f:
