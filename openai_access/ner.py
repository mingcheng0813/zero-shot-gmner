...
def test_batch_mode():
    ...
    with open('result/zero-shot-no-demo/samples1500/NER/batch_request.json', 'w', encoding='utf-8') as f:
    ...
    # 加载jsonl文件
    # responses = []
    # with open('result/zero-shot-demo/ner/batch_67e6814c43248190b37b8b79226f074a_output.jsonl', 'r', encoding='utf-8') as f:
    #     for line in f:
    #         if line.strip():  # 忽略空行
            ...
            try:
                ...
                try:
                    ...
                    if input_match and output_match:
                        ...
                        print(f"成功提取input和output字段，跳过reasoning content")
                    else:
    ...
    with open('result/zero-shot-no-demo/samples1500/NER/ner_results.json', 'w', encoding='utf-8') as f:
