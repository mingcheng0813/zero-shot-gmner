...
def test_batch_mode():
    ...
    # 读取 all_prompts.md
    prompts_file_path = r'prompts/zero-shot-no-demo/实体格式验证/valition_format.md'
    prompts = load_prompts(prompts_file_path)
    ...
    with open('result/zero-shot-demo/format_val/batch_request.json', 'w', encoding='utf-8') as f:
    ...
    with open('result/zero-shot-demo/format_val/format_val_results.json', 'w', encoding='utf-8') as f:
